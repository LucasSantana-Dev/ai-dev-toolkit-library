/**
 * Import standalone scripts/CLIs from ai-dev-toolkit/tools as `tool` kind.
 *
...
const ADT_TOOLS = "/Volumes/External HD/Desenvolvimento/ai-dev-toolkit/tools";
...
async function importOne(filename: string, destRoot: string, written: string[], skipped: Array<[string, string]>) {
  ...
  const manifest = {
    ...
    homepage: `https://github.com/LucasSantana-Dev/ai-dev-toolkit/blob/main/tools/${filename}`,
    license: "MIT",
