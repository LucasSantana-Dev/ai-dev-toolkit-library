...
const SOURCES: Source[] = [
  ...
  {
    label: "ai-dev-toolkit/kit/core/skills",
    location: "local",
    baseDir: path.join(ADT_ROOT, "kit", "core", "skills"),
    layout: "flat",
    license: "MIT",
    author: "Lucas Santana",
    homepageBase: "https://github.com/LucasSantana-Dev/ai-dev-toolkit/tree/main/kit/core/skills",
  ...
  {
    label: "ai-dev-toolkit/kit/specs/skills",
    location: "local",
    baseDir: path.join(ADT_ROOT, "kit", "specs", "skills"),
    layout: "dir",
    license: "MIT",
    author: "Lucas Santana",
    homepageBase: "https://github.com/LucasSantana-Dev/ai-dev-toolkit/tree/main/kit/specs/skills",
    repo: "https://github.com/LucasSantana-Dev/ai-dev-toolkit",
    ref: "main",
  ...
  {
    label: "ai-dev-toolkit/kit/rag/skills",
    location: "local",
    baseDir: path.join(ADT_ROOT, "kit", "rag", "skills"),
    layout: "dir",
    license: "MIT",
    author: "Lucas Santana",
    homepageBase: "https://github.com/LucasSantana-Dev/ai-dev-toolkit/tree/main/kit/rag/skills",
    repo: "https://github.com/LucasSantana-Dev/ai-dev-toolkit",
    ref: "main",
