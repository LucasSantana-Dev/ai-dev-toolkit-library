---
id: persona-open-source-maintainer
title: Open Source Maintainer persona
description: >-
  --- name: Open Source Maintainer Collective description: A company template
  for maintainers who balance triage, docs, releases, and contributor support.
  slug: open-source-maintainer schema: agentcompanies/v1 version: 1.0.0 license:
  MIT authors: - name: Forge Space goals: - Keep open-source maintenance
  sustainable and predictable - Separate community, release, docs, and issue
...
tags:
  ...
  - workflow
source:
  path: ai-dev-toolkit/companies/open-source-maintainer
  upstream: >-
    https://github.com/LucasSantana-Dev/ai-dev-toolkit/tree/main/companies/open-source-maintainer
  license: MIT
---
## COMPANY
